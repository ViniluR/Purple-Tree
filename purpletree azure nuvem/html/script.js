...
function redirectPost(event, id) {
    ...
    if (event.target === div || event.target === botoes || event.target === conteudo || event.target === header) {
        window.location.href = `http://ics-purpletreeweb.freedynamicdns.net/post/post.php?id=${id}`;
    }
}

function redirectComment(id) {
    window.location.href = `http://ics-purpletreeweb.freedynamicdns.net/postar.php?id=${id}`;
}

function redirectEdit(id) {
    window.location.href = `http://ics-purpletreeweb.freedynamicdns.net/post/edit-post.php?id=${id}`;
}
...
function Excluir(id) {
    window.location.href = `http://ics-purpletreeweb.freedynamicdns.net/post/excluir-post.php?id=${id}`
}

function copiarlink(id) {
    var link = `http://ics-purpletreeweb.freedynamicdns.net/post/post.php?id=${id}`;
...
function redirectLogin(){
    window.location.href = "http://ics-purpletreeweb.freedynamicdns.net/login.php";
}

// perfil

function redirectPerfil(id) {
    window.location.href = `http://ics-purpletreeweb.freedynamicdns.net/perfil.php?username=${id}`;
}
