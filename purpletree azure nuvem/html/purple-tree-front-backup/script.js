...
function copiarlink(id) {
    var link = `http://ics-purpletreeweb.freedynamicdns.net/purple-tree/post/post.php?id=${id}`;
...
function redirectPerfil(id) {
    window.location.href = `http://ics-purpletreeweb.freedynamicdns.net/purple-tree/perfil.php?username=${id}`;
}
